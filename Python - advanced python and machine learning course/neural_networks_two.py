...
#      THE CALCULATIONS CAN BE VIEWED AS APPLYING WEIGHTS AND BIAS TO INPUT AND OUTPUT
...
#      RECTIFIED LINEAR UNIT (RELU); ZERO UNTIL CERTAIN THRESHOLD AND THEN LINEAR; MOST POPULAR SINCE IT COMPUTATIONALLY CHEAP + ROBUST TO VANISHING GRADIENTS
