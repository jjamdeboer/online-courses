...
# BUT IF YOU IMPORT SEABORN, PLOTS LOOK NICER, SINCE PANDAS THEN AUTOMATICALLY SWITCHES TO SEABORN-STYLE
import seaborn
...
pyplot.show()
df1.plot(kind = 'hexbin', x = 'A', y = 'D',cmap = 'magma', gridsize = 40)
pyplot.show()
